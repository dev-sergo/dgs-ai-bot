...
УЖЕ посчитанные числа (revenue — выручка и динамика; returns_sum — деньги в возвратах;
discounts — сумма скидок; bottom_products — слабые позиции меню с выручкой и прибылью).
